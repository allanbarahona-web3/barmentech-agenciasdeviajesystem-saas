...
const workspaceSelect=Prisma.validator<Prisma.BillingDocumentSelect>()({
  ...
  confirmedAt:true,submittedAt:true,issuedAt:true,taxAuthorityFinalizedAt:true,createdAt:true,updatedAt:true,paymentConditionCode:true,creditTermDays:true,
  ...
  implements BillingDocumentRepository
{
  ...
  async findWorkspace(tenantId: string, documentId: string):Promise<BillingDocumentWorkspace|null> {
    ...
    return {
      ...
      confirmedAt:workspaceTimestamp(document.confirmedAt),submittedAt:workspaceTimestamp(document.submittedAt),issuedAt:workspaceTimestamp(document.issuedAt),taxAuthorityFinalizedAt:workspaceTimestamp(document.taxAuthorityFinalizedAt),
