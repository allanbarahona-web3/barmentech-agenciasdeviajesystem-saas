...
function input(id="document-a",fiscalNumber=FISCAL_NUMBER):BillingDocumentSubmissionPreparationResult{return{identity:{tenantId:"tenant-a",billingDocumentId:id},allocationIdentity:{billingDocumentNumberSequenceId:"sequence-a",allocatedSequenceNumber:"42"},recoveryIdentity:{fiscalNumber,documentTypeCode:"01",issuanceIdempotencyKey:`billing-document:${id}:electronic-issuance:v1`,fiscalEmissionAt:new Date("2026-08-24T06:00:00Z"),fiscalIssueDate:"2026-08-24",issuedAt:null},preparedSubmission:{endpoint:"/documents/factura",canonicalBody:'{"safe":true}',requestHash:HASH,idempotencyKey:`billing-document:${id}:electronic-issuance:v1`,metadata:{billingDocumentId:id,tenantId:"tenant-a",documentTypeCode:"01",fiscalNumber,fiscalIssueDate:"2026-08-24"}},providerState:{billingMode:"ELECTRONIC_PROVIDER",lifecycleStatus:"CONFIRMED",providerStatus:"PENDING",taxAuthorityStatus:"NOT_SUBMITTED",providerDocumentId:null,providerEnvironment:null,providerRequestHash:null,providerLastAttemptAt:null,providerLastErrorCode:null,providerLastErrorAt:null,providerReconciliationRequired:false,haciendaKey:null,submittedAt:null}};}
