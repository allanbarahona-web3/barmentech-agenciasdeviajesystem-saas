...
describe("customerAccountStatementTemplate", () => {
  it("renders dates and payment methods as business-facing values without raw ISO fragments", () => {
    const statement: CustomerAccountStatement = {
      ...
      charges: [{ id: "ar-1", sourceType: "ACCOUNT_RECEIVABLE", sourceId: "ar-1", reference: "FE-1", description: "Factura electrónica", recognizedAt: new Date("2026-09-01T01:30:00.000Z"), dueDate: new Date("2026-09-01T00:00:00.000Z"), originalAmount: "100.00", allocatedAmount: "40.00", outstandingAmount: "60.00", status: "PARTIALLY_SETTLED", allocations: [{ receiptNumber: "RCP-1", amount: "40.00", allocatedAt: new Date("2026-09-01T01:30:00.000Z"), status: "ACTIVE", statusLabel: "Aplicado" }] }],
      payments: [{ id: "payment-1", receiptNumber: "RCP-1", receivedAt: new Date("2026-09-01T01:30:00.000Z"), receivedAmount: "50.00", availableAmount: "10.00", paymentMethod: "BANK_TRANSFER", paymentMethodLabel: "Transferencia bancaria", purpose: "GENERAL", purposeLabel: "Pago", status: "PARTIALLY_ALLOCATED", allocations: [{ sourceType: "ACCOUNT_RECEIVABLE", reference: "FE-1", amount: "40.00", allocatedAt: new Date("2026-09-01T01:30:00.000Z"), status: "ACTIVE", statusLabel: "Aplicado", reversedAt: null, reversalReason: null }] }],
    };
