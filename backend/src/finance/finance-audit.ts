...
export const FINANCE_AUDIT_ACTIONS = {
  ...
  REPORTED_INVOICE_PAYMENT_SUBMITTED: "REPORTED_INVOICE_PAYMENT_SUBMITTED",
  REPORTED_INVOICE_PAYMENT_APPROVED: "REPORTED_INVOICE_PAYMENT_APPROVED",
  REPORTED_INVOICE_PAYMENT_REJECTED: "REPORTED_INVOICE_PAYMENT_REJECTED",
  PAYMENT_DESTINATION_OVERRIDE_ACCEPTED: "PAYMENT_DESTINATION_OVERRIDE_ACCEPTED",
  APPLIED: "APPLIED",
  REVERSED: "REVERSED",
  CANCELLED: "CANCELLED",
