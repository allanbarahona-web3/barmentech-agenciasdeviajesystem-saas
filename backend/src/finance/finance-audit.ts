...
export const FINANCE_AUDIT_ACTIONS = {
  ...
  REPORTED_CONTRACT_PAYMENT_SUBMITTED: "REPORTED_CONTRACT_PAYMENT_SUBMITTED",
  REPORTED_CONTRACT_PAYMENT_APPROVED: "REPORTED_CONTRACT_PAYMENT_APPROVED",
  REPORTED_CONTRACT_PAYMENT_REJECTED: "REPORTED_CONTRACT_PAYMENT_REJECTED",
