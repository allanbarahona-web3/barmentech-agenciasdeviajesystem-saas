...
import { ContractNotesStep } from "@/features/contracts-form/wizard/steps/notes/ContractNotesStep";
...
type ContractsFormProps = {
  ...
  handleValidateCompanionIdentity: (companionId: string, idNumber: string, fullName: string, idType: IdType) => Promise<void>;
